...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33 style33 style43">View Ultra Violet Results</span> !!! </h2>
          <div class="clr"></div>
          
        <iframe width="650" height="350" src="A_Results_UV.jsp"></iframe>
            <p>&nbsp;</p>
