...
<head>
<title>A_Datasets_Humidity_Results</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33 style33 style43">View Device Name Results</span> !!! </h2>
          <div class="clr"></div>
          
        <iframe width="650" height="350" src="A_dl_Results.jsp"></iframe>
            <p>&nbsp;</p>
