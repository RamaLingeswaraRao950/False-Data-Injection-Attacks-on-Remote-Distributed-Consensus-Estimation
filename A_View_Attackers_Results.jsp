...
<head>
<title>A_View_Attackers_Results</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33 style33 style43">View Attackers Results</span> !!! </h2>
          <div class="clr"></div>
          
        <iframe width="650" height="350" src="A_Results_Attackers.jsp"></iframe>
            <p>&nbsp;</p>
